...
class OpenAIClientAdapter:
    ...
    def understand_turn(
        ...
        prompt = (
            ...
            "unknown. A vague amount such as 'not much', 'a little', or 'some' is not zero and needs "
            "clarification; return null for its value. 'I do not want to share' is refusal. A request to "
            "explain the question is clarification. "
